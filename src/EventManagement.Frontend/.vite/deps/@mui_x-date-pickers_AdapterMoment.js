  ...
  constructor({
    ...
    this.setTimezone = (value, timezone) => {
      ...
      const cleanZone = timezone === "default" ? (
        // @ts-ignore
        (_this$moment$defaultZ2 = (_this$moment$defaultZ3 = this.moment.defaultZone) == null ? void 0 : _this$moment$defaultZ3.name) != null ? _this$moment$defaultZ2 : "system"
      ) : timezone;
      if (cleanZone === "system") {
        return value.clone().local();
      }
