...
var require_index_min = __commonJS({
  "node_modules/axios-auth-refresh/dist/index.min.js"(exports, module) {
    !function(e, t) {
      ...
      return function() {
        ...
        var t = { 593: function(e2, t2, r2) {
          ...
          t2.defaultOptions = { statusCodes: [401], pauseInstanceWhileRefreshing: false }, t2.mergeOptions = function(e3, t3) {
            ...
            return void 0 === t3.requestQueueInterceptorId && (t3.requestQueueInterceptorId = e3.interceptors.request.use((e4) => t3.refreshCall.catch(() => {
        ...
        return function() {
          ...
          e2.default = function(e3, r2, s2 = {}) {
            ...
            return e3.interceptors.response.use((e4) => e4, (o) => {
              ...
              return (0, t2.createRequestQueueInterceptor)(e3, n2, s2), u.catch((e4) => Promise.reject(e4)).then(() => (0, t2.resendFailedRequest)(o, (0, t2.getRetryInstance)(e3, s2))).finally(() => (0, t2.unsetCache)(e3, n2));
            });
          };
        }(), n;
      }();
