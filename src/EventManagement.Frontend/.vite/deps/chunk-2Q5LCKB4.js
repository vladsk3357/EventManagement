...
var _excluded4 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React4.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime5.jsxs)(React4.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime5.jsxs)(React4.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
//# sourceMappingURL=chunk-2Q5LCKB4.js.map
